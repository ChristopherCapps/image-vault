...
public class Console {
  ...
  public static final String BLORPLE_PREFIX = "blorple";
  ...
  public static String blorple(final String format, final Object... args) {
    return print(BLORPLE_PREFIX, format, args);
  }
